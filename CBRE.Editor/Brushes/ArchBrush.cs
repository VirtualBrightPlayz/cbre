...
namespace CBRE.Editor.Brushes {
    public class ArchBrush : IBrush {
        ...
        public ArchBrush() {
            ...
            _tiltAngle = new NumericControl(this) { LabelText = "Tilt angle", Minimum = -Atan2, Maximum = Atan2, Value = 0, ControlEnabled = false, Precision = 1 };
            _tiltInterp = new BooleanControl(this) { LabelText = "Tilt interpolation", Checked = false, ControlEnabled = false };

            _curvedRamp.ValuesChanged += (s, b) => _tiltAngle.ControlEnabled = _tiltInterp.ControlEnabled = _curvedRamp.GetValue();
        }
        ...
        public IEnumerable<MapObject> Create(IDGenerator generator, Box box, ITexture texture, int roundDecimals) {
            ...
            // Calculate the Vector3s of the inner and outer ellipses' points
