...
namespace CBRE.Editor.Brushes {
    public class TorusBrush : IBrush {
        ...
        public TorusBrush() {
            ...
            _crossArc = new NumericControl(this) { LabelText = "Cross sec. arc", Minimum = 1, Maximum = 360, Value = 360, ControlEnabled = false };
            _crossWallWidth = new NumericControl(this) { LabelText = "Hollow wall width", Minimum = 1, Maximum = 1024, Value = 16, Precision = 1, ControlEnabled = false };
            ...
            _crossMakeHollow.ValuesChanged += (s, b) => _crossWallWidth.ControlEnabled = _crossArc.ControlEnabled = _crossMakeHollow.GetValue();
        }
